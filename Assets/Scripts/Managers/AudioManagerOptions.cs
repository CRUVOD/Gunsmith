...
/// <summary>
/// A class used to store options for AudioManagers 
/// </summary>

public struct AudioManagerOptions
{
    /// the track on which to play the sound
    public AudioManager.AudioManagerTracks AudioManagerTrack;
    ...
    public static AudioManagerOptions Default
    {
        get
        {
            ...
            defaultOptions.AudioManagerTrack = AudioManager.AudioManagerTracks.Sfx;
