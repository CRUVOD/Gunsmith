...
/// <summary>
/// This decision will always return true.
/// Returns true after the specified duration, picked randomly between the min and max values (in seconds) has passed 
/// since the Core has been in the state this decision is in. Use it to do something X seconds after having done something else.
/// Like a cool down really
/// </summary>
public class AITimeInStateDecision : AIDecision
{
    ...
    protected virtual bool EvaluateTime()
    {
        ...
        return (core.TimeInThisState >= _randomTime);
    }
