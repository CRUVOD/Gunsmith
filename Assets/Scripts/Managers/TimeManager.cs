...
{
    public delegate void Delegate(TimeScaleMethods timeScaleMethod, float timeScale, float duration, bool lerp, float lerpSpeed, bool infinite);
    ...
    static public void Trigger(TimeScaleMethods timeScaleMethod, float timeScale, float duration, bool lerp, float lerpSpeed, bool infinite)
    {
...
/// <summary>
/// Put this component in your scene and it'll catch FreezeFrameEvents and TimeScaleEvents, allowing you to control the flow of time.
/// </summary>
public class TimeManager : MonoBehaviour
{
    ...
    {
        TimeScaleEvent.Trigger(TimeScaleMethods.For, 0.5f, 3f, true, 1f, false);
    }
    ...
    {
        TimeScaleEvent.Trigger(TimeScaleMethods.For, newNormalTimeScale, 0f, false, 0f, true);
    }
    ...
    public virtual void OnTimeScaleEvent(TimeScaleMethods timeScaleMethod, float timeScale, float duration, bool lerp, float lerpSpeed, bool infinite)
    {
        ...
        switch (timeScaleMethod)
        {
            ...
            case TimeScaleMethods.Unfreeze:
                Unfreeze();
                break;
        }
    }
    ...
    void OnEnable()
    {
        FreezeFrameEvent.Register(OnFreezeFrameEvent);
        TimeScaleEvent.Register(OnTimeScaleEvent);
    }
    ...
    void OnDisable()
    {
        FreezeFrameEvent.Unregister(OnFreezeFrameEvent);
        TimeScaleEvent.Unregister(OnTimeScaleEvent);
    }
}
