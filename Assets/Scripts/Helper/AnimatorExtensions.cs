...
public static class AnimatorExtensions
{
    ...
    public static bool AnimHasParameterOfType(this Animator self, string name, AnimatorControllerParameterType type)
    {
    ...
    public static void AddAnimatorParameterIfExists(Animator animator, string parameterName, out int parameter, AnimatorControllerParameterType type, HashSet<int> parameterList)
    {
        ...
        if (animator.AnimHasParameterOfType(parameterName, type))
        {
    ...
    {
        if (animator.AnimHasParameterOfType(parameterName, AnimatorControllerParameterType.Bool))
        {
            animator.SetBool(parameterName, value);
        }
    }
    ...
    {
        if (animator.AnimHasParameterOfType(parameterName, AnimatorControllerParameterType.Trigger))
        {
            animator.SetTrigger(parameterName);
        }
    }
    ...
    {
        if (animator.AnimHasParameterOfType(parameterName, AnimatorControllerParameterType.Float))
        {
            animator.SetFloat(parameterName, value);
        }
    }
    ...
    {
        if (animator.AnimHasParameterOfType(parameterName, AnimatorControllerParameterType.Int))
        {
            animator.SetInteger(parameterName, value);
        }
    }
